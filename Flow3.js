                ...
                "reservations": {
                    "reservation": {
                        "roomStay": {
                            ...
                            "expectedTimes": {
                                "reservationExpectedArrivalTime": "2024-10-16",
                                "reservationExpectedDepartureTime": "2024-10-17"
                            },
                            "guarantee": {
                                "guaranteeCode": "CC",
                                "onHold": "false"
...
it('POST Create share Reservation', async function ({ supertest }) {
    await supertest
        .request(reservation.request)
        .post(`/rsv/v1/hotels/GRVXX/reservations/${reservationId}/shares`)
        .set('Content-Type', reservation['Content-Type1'])
        .set('x-hotelid', reservation.hotelId)
        .set('x-app-key', reservation['x-app-key1'])
        .set('bypass-routing', reservation['bypass-routing'])
